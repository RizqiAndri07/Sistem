<template>
  <section class="bg-x-lavender-grey p-20">
    <h1 class="heading1 text-center">Privacy Policy</h1>
    <p class="body1 text-x-medium-grey text-center">
      Last Updated on 27th January 2022
    </p>
  </section>
  <section class="flex flex-col gap-5 my-36 mx-auto w-1/2">
